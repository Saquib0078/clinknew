...
const {CreateGraphics,getGraphics,GetGraphics,UpdateGraphics,CreateSlider,CreatechipButtonList,
    DeleteChipButtonList,UpdateChipButtonList,DeleteSlider,UpdateSlider,DeleteGraphics,DeleteAnyGraphicsImage, GetChipButtonList,GetSlider,GetGraphicsById} = require("../controllers/user/graphicsController");
...
router.get("/getGraphicsData/:id", GetGraphicsById);
...
router.delete("/controllers/AnyGraphicImage/:id",DeleteAnyGraphicsImage);
